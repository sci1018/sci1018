# Analyse de fréquences et test du khi carré ($\chi^2$) {#lecon5}
...
:::{.exemple section=5}
On applique le calcul des fréquences théoriques aux données de l'échantillon de couleur des yeux et des cheveux. Le tableau \@ref(tab:fihat) montre les fréquences observées avec les fréquences théoriques entre parenthèses. Pour illustrer, la fréquence théorique des individus avec des cheveux pâles et des yeux bleus s'obtient: 
...
```{r fihat, echo = FALSE, keep.source = FALSE}
df <- data.frame(
