...
```{r boxplot, echo=TRUE, fig.align='center', fig.cap="boxplot"}
...
```{r plot, echo=TRUE, fig.align='center', fig.cap="Différents types de graphiques obtenus avec la fonction \texttt{plot( )}."}
