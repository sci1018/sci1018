...
<!--chapter:end:Module_1/index.Rmd-->
...
<!--chapter:end:Lecon_6.Rmd-->

`r if (knitr::is_html_output()) '
# References {-}
'`

<!--chapter:end:Lecon_7.Rmd-->

# theorie 8

<!--chapter:end:Lecon_8.Rmd-->

# Théorie 9

<!--chapter:end:Lecon_9.Rmd-->

# Théorie 10

<!--chapter:end:Lecon_10.Rmd-->

# Examen

<!--chapter:end:Examen.Rmd-->
