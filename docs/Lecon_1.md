...
**Exemple 1.2** Disons qu'après un décompte d'insectes sur 5 quadrats^[Un quadrat est une unité spatiale de dimension donnée (1 m × 1 m, 10 m × 10 m), disposée dans un site d'étude sur laquelle on fait des mesures en écologie, ici un décompte d'insectes.] dans un champ agricole, on observe les abondances suivantes: 10, 1, 1000, 1, 10.
...
<div class="figure">
<img src="Lecon_1_files/figure-html/histomode-1.png" alt="Histogramme illustrant une distribution unimodale (a) et bimodale (b)." width="672" />
<p class="caption">(\#fig:histomode)Histogramme illustrant une distribution unimodale (a) et bimodale (b).</p>
</div>
...
<div class="figure">
<img src="Lecon_1_files/figure-html/variance-1.png" alt="Effet du nombre d'observations sur l'estimation de la variance. À noter que la ligne pointillée représente la vraie valeur de la population ($\sigma^2 = 4$) à partir de laquelle les observations ont été sélectionnées aléatoirement" width="672" />
<p class="caption">(\#fig:variance)Effet du nombre d'observations sur l'estimation de la variance. À noter que la ligne pointillée représente la vraie valeur de la population ($\sigma^2 = 4$) à partir de laquelle les observations ont été sélectionnées aléatoirement</p>
</div>
...
<div class="figure">
<img src="Lecon_1_files/figure-html/randomvar-1.png" alt="Présentation des longueurs de 100 serpents (variable continue, a) et du nombre de pucerons dans 100 sites (variable discrète, b)" width="672" />
<p class="caption">(\#fig:randomvar)Présentation des longueurs de 100 serpents (variable continue, a) et du nombre de pucerons dans 100 sites (variable discrète, b)</p>
</div>
...
<div class="figure">
<img src="Lecon_1_files/figure-html/normdensity-1.png" alt="Distribution normale d'une population de masses de souris où la moyenne est de 4.1 g et l'écart-type est de 1.5 g. À noter qu'on peut tracer la courbe de la distribution en substituant une série de valeurs de $x$ dans la fonction de densité de probabilité pour un $\mu = 4.1$ et $\sigma = 1.5$, c.-à-d., N(4.1, 1.5)." width="672" />
<p class="caption">(\#fig:normdensity)Distribution normale d'une population de masses de souris où la moyenne est de 4.1 g et l'écart-type est de 1.5 g. À noter qu'on peut tracer la courbe de la distribution en substituant une série de valeurs de $x$ dans la fonction de densité de probabilité pour un $\mu = 4.1$ et $\sigma = 1.5$, c.-à-d., N(4.1, 1.5).</p>
</div>
...
<div class="figure">
<img src="Lecon_1_files/figure-html/shape-1.png" alt="Position de distributions normales avec même variance, mais différentes moyennes (a) et forme de distributions normales pour des variances différentes, mais une même moyenne (b)." width="672" />
<p class="caption">(\#fig:shape)Position de distributions normales avec même variance, mais différentes moyennes (a) et forme de distributions normales pour des variances différentes, mais une même moyenne (b).</p>
</div>
...
<div class="figure">
<img src="Lecon_1_files/figure-html/standardnormal-1.png" alt="Distribution normale centrée réduite, c.-à-d., N(0, 1)." width="672" />
<p class="caption">(\#fig:standardnormal)Distribution normale centrée réduite, c.-à-d., N(0, 1).</p>
</div>
...
<div class="figure">
<img src="Lecon_1_files/figure-html/zex1-1.png" alt="Écart normal associé à une longueur d'ailes de puceron de 22.6 mm." width="672" />
<p class="caption">(\#fig:zex1)Écart normal associé à une longueur d'ailes de puceron de 22.6 mm.</p>
</div>
...
$$
<div class="figure">
<img src="Lecon_1_files/figure-html/zex2-1.png" alt="Probabilité cumulative associée à une valeur $\leq$ 160 cm dans une population avec N(170, 8)." width="672" />
<p class="caption">(\#fig:zex2)Probabilité cumulative associée à une valeur $\leq$ 160 cm dans une population avec N(170, 8).</p>
</div>
...
**Exemple 1.11** Si on veut connaître la probabilité qu'un individu ait une taille supérieure à 185 cm dans la même population que celle de notre exemple précédent (édifice à bureaux), on pourrait encore une fois utiliser l'écart normal. Ainsi, on peut écrire :
...
<div class="figure">
<img src="Lecon_1_files/figure-html/zex3-1.png" alt="Probabilité cumulative associée à une valeur &gt; 185 cm dans une population avec N(170, 8)." width="672" />
<p class="caption">(\#fig:zex3)Probabilité cumulative associée à une valeur > 185 cm dans une population avec N(170, 8).</p>
</div>
...
**Exemple 1.12** Il est possible de déterminer la probabilité d'observer une valeur entre 165 cm et 180 cm dans la même population. Pour ce faire, il faut calculer la probabilité cumulative associée à chacune des bornes, comme suit :
...
$$
<div class="figure">
<img src="Lecon_1_files/figure-html/zex4-1.png" alt="Probabilité cumulative associée à 165 cm $\leq$ $\ x_i$ $\leq$ 180 cm dans une population avec N(170, 8)." width="672" />
<p class="caption">(\#fig:zex4)Probabilité cumulative associée à 165 cm $\leq$ $\ x_i$ $\leq$ 180 cm dans une population avec N(170, 8).</p>
</div>
